...
function openssHint(itemNum) {
	...
	if (itemNum == 1) {
		...
		statusmenu += "</br><font color='#CC0066'>2&nbsp;&nbsp;</font>请依次输入以下命令，等待上一条命令执行完后再运行下一条(这里以回滚4.3.2为例)：";
		statusmenu += "</br></br>&nbsp;&nbsp;&nbsp;&nbsp;cd /tmp";
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;wget --no-check-certificate https://github.com/cutsin/fancyss/raw/master/fancyss_arm/history_package/shadowsocks_4.3.2.tar.gz";
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;mv shadowsocks_4.3.2.tar.gz shadowsocks.tar.gz";
		...
		statusmenu += "</br>回滚其它版本号，请参考<a href='https://github.com/cutsin/fancyss/tree/master/fancyss_arm/history_package' target='_blank'><u><font color='#00F'>版本历史列表</font></u></a>";
