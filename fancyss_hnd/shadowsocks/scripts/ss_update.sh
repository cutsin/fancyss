...
main_url="https://raw.githubusercontent.com/cutsin/fancyss/master/fancyss_hnd"
backup_url=""
...
update_ss2(){
	...
	echo_date "历史版本下载地址：https://github.com/cutsin/fancyss_history_package/tree/master/fancyss_hnd"
